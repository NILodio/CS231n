...
def init(force_download=False):
    if force_download or not os.path.exists("cs231n"):
        print("replicating cs231n resources")
        ...
        z.extractall()
        if os.path.exists("cs231n"):
            shutil.rmtree("cs231n")
        shutil.move(dirname+"/cs231n", "cs231n")
        shutil.rmtree(dirname)
